//
//  SceneLocationView+MKPolyline.swift
//  NavigationDemo
//
//  Created by Jordan.Dixon on 14/10/2017.
...
extension SceneLocationView {
    ...
    func nodes(for polyline: MKPolyline) -> [LocationNode] {
        guard let altitude = currentLocation()?.altitude else { return [LocationNode]() }
        
        return LocationNode.create(polyline: polyline, altitude: altitude - 2)
    }
